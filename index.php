...
<ul>
    ...
    <li><?php print_r("Информация для диллеров: ");
        print_r($carToyota->methodSale("Russia", "Sol", "Manual")); ?></li>
</ul>
...
<ul>
    ...
    <li><?php print_r("Информация для диллеров: ");
        print_r($carBMW->methodSale($carBMW->region, $carBMW->package, $carBMW->transmission)); ?></li>
</ul>
